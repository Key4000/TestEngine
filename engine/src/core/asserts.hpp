...
#include <defines.hpp>
/*
*  функция обработки условий , реализация лежит в logger.cpp для доступа к системе логирования
* (строковое представление выражения, которое вызвало сбой)
* (дополнительное сообщение о причине сбоя)
* (имя файла, где произошло нарушение)
* (строка, на которой произошёл сбой)
*/

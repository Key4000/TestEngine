...
class TE_API Application {
   ...
   private:
     ...
     */
    static b8 application_on_key(u16 code, void* sender, void* listener, EventContext context);
    /**
     ...
     */
    static b8 application_on_quit(u16 code, void* sender, void* listener, EventContext context);
